# Generated by Django 5.0.3 on 2024-08-27 12:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SENDER', 'Sender'), ('RECEIVER', 'Receiver'), ('AGENT', 'Agent')], default='SENDER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='processed_transactions', to=settings.AUTH_USER_MODEL)),
